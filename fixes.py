...
def apply_patches():
    ...
    # 5. Force description to be business-focused and preserve all verified data
    try:
        from domain_classifier.enrichment import description_enhancer
        
        # Replace both description enhancement functions
        ...
        description_enhancer.enhance_company_description = lambda desc, apollo, classification: safe_generate_description(classification, apollo)
