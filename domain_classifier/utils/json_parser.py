"""Centralized JSON parsing module for domain classifier."""
import logging
import json
import re
...
def clean_json_string(json_str: str) -> str:
    """
    Clean a JSON string by removing control characters and fixing common LLM-generated JSON issues.
    ...
    # Handle the problematic pattern: "score": X, 0
    # This is a critical fix for Claude's output format
    json_str = re.sub(r'": (\d+),\s*0([,}])', r'": \1\2', json_str)
    
    # Handle numbers with commas (like "90, 0" should be "90")
...
def ensure_dict(data: Union[Dict[str, Any], str, None], field_name: str = "unknown") -> Dict[str, Any]:
    """
